...
This separator contains a series of visual-only mods that can be easily disabled/enabled based on user preference. They will be discussed below.
 ...
 6. `Enhanced Volumetric Lighting and Shadows`: EVLaS "improves" Skyrim's Volumetric lighting at the cost of performance and potentially worse visuals at most times of day outside of Dawn/Dusk. Disabled by default due to author preference.
